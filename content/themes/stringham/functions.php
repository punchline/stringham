...
function stringham_scripts() {
	...
	wp_register_script( 'flot-pie-js', get_stylesheet_directory_uri() . '/js/vendors/flotchart/jquery.flot.pie.min.js', array(), null, TRUE );
	...
	wp_register_script( 'morris-min-js', get_stylesheet_directory_uri() . '/js/vendors/morris/morris.min.js', array('raphael-min.js', 'jquery'), '0.5.1', TRUE );
	...
	wp_register_script( 'summernote-js', get_stylesheet_directory_uri() . '/js/vendors/summernote/summernote.min.js', array(), null, TRUE );
	
	// TouchPunch.JS
	// https://github.com/furf/jquery-ui-touch-punch/
	wp_register_script( 'touch-punch-js', get_stylesheet_directory_uri() . '/js/vendors/touch-punch/jquery.ui.touch-punch.min.js', array(), null, TRUE );
	
	/* X-Editable JavaScript Files */
	wp_register_script( 'address-js', get_stylesheet_directory_uri() . '/js/vendors/x-editable/address.js', array(), null, TRUE );
	...
	wp_register_script( 'demo-mock-js', get_stylesheet_directory_uri() . '/js/vendors/x-editable/demo-mock.js', array(), null, TRUE );
