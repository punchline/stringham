...
function(eventBus){
    ...
    function getLocalData(element, channel) {
         eventBus.emit('data.arrived', element.innerHTML, channel);
    }
    ...
    function findPosition(element) {
        var curleft = 0, curtop = 0,
            htmlOffset = +document.documentElement.offsetTop || 0;
        ...
        return { x: curleft, y: curtop + htmlOffset };
    }
