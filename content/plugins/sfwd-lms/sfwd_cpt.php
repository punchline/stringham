...
if ( !class_exists( 'SFWD_CPT' ) ) {
	abstract class SFWD_CPT extends Semper_Fi_Module {
		...
		function add_post_type() {
            ...
            $learndash_flush_rewrite_rules = apply_filters("learndash_flush_rewrite_rules", true, $this->post_options);
			if($learndash_flush_rewrite_rules && !empty($this->post_options['rewrite']['slug']) && empty($rewrite_rules[$this->post_options['rewrite']['slug'].'/?$'])) {
